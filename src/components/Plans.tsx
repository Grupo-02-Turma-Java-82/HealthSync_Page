...
import { Crown, Heart, Users, Check } from 'lucide-react'; // Exemplo de importação de ícones
...
export function Plans() {
  const plans = [
    {
      ...
      pricePer: '/mês',
      details: 'Gerencie todos os seus alunos em um só lugar. O valor se ajusta de acordo com sua base de clientes.',
      features: [
    ...
    },
    {
      ...
      price: 'R$ 29',
      pricePer: '/mês',
      details: 'Acesso total aos nossos treinos e funcionalidades para você treinar por conta própria.',
      features: [
    ...
    },
    {
      ...
      details: 'Aproveite todas as funcionalidades sob a supervisão do seu personal trainer.',
      features: [
  ...
  return (
    <section id="planos" className="py-20 bg-gradient-to-br from-mint-cream to-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-heading font-bold text-foreground mb-4">Escolha o Plano Ideal</h2>
